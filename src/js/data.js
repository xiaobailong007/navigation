    ...
    boxList: [
      ...
      },
      {
        ...
        list: [
          ...
          {
            href:
              'https://blog.poetries.top/FE-Interview-Questions/docs/base.html',
      ...
      },
      {
        ...
        list: [
          ...
          {
            href: 'https://www.binfoo.com/',
            src: require('../images/宾否.ico').default,
            name: '宾否',
            text: 'IT学习资源',
          },
          {
      ...
      },
      {
        ...
        list: [
          ...
          {
            href:
              'https://lhammer.cn/You-need-to-know-css/#/zh-cn/introduce?v=1',
      ...
      },
      {
        ...
        list: [
          ...
          {
            href:
              'https://note.youdao.com/web/#/file/recent/markdown/WEB80575f5bd4619671a7ad032db131fd6b/',
          ...
          {
            href:
              'https://analytics.google.com/analytics/web/#/report-home/a157349190w221495475p210595989',
      ...
      },
      {
        ...
        list: [
          ...
          {
            href:
              'https://www.google.com/maps/@35.274241,160.2981017,3z?hl=zh-CN',
      ...
      },
      {
        ...
        list: [
          ...
          {
            href:
              'https://cloud.tencent.com/act/cps/redirect?redirect=1053&cps_key=789d07ea8be50b3706f29b464fe131ad&from=console',
      ...
      },
      {
        ...
        list: [
          ...
          {
            href:
              'https://emumo.xiami.com/apps/mobile?spm=a2oj1.12028025.topnav.5.54776ee1me1a2G',
            src: require('../images/虾米音乐.png').default,
            name: '虾米音乐',
            text: '88会员音乐',
          },
